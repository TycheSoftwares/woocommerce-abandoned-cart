		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0"><b>Your Shopping Cart</b>
			<tbody>
				...
				<tr style="background-color:#f4f5f4;">
					<td><img src = "<?php echo esc_url( plugins_url() ); ?>/woocommerce-abandoned-cart/assets/images/spectre.jpg" height="40px" width="40px"></td><td>Spectre</td><td> <?php echo wp_kses( $wcal_price, $allowed_html ); ?></td><td>2</td><td><?php echo wp_kses( $wcal_total_price, $allowed_html ); ?> </td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
