...
if ( ! class_exists( 'woocommerce_abandon_cart_lite' ) ) {
    ...
    class woocommerce_abandon_cart_lite {
        ...
        //    add_action ( 'woocommerce_cart_updated',                    array( &$this, 'wcal_store_cart_timestamp' ) );
            add_action( 'woocommerce_add_to_cart',                    array( &$this, 'wcal_store_cart_timestamp' ), 99 );
            add_action( 'woocommerce_cart_item_removed',            array( &$this, 'wcal_store_cart_timestamp' ), 99 );
            add_action( 'woocommerce_cart_item_restored',           array( &$this, 'wcal_store_cart_timestamp' ), 99 );
            add_action( 'woocommerce_after_cart_item_quantity_update', array( &$this, 'wcal_store_cart_timestamp' ), 99 );
