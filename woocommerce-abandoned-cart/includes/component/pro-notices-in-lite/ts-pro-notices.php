...
class Wcal_ts_pro_notices {
	...
	*/
	...
	public function __construct( $ts_plugin_name = '', $ts_plugin_prefix = '', $ts_pro_plugin_prefix = '', $ts_notices = array(), $ts_file = '', $ts_pro_file = '' ) {
		...
		//Add pro notices
        add_action( 'admin_notices', array( 'Wcal_ts_pro_notices', 'ts_notices_of_pro' ) );
		add_action( 'admin_init', array( 'Wcal_ts_pro_notices', 'ts_ignore_pro_notices' ) );
		
		add_action( self::$plugin_prefix . '_activate', array( 'Wcal_ts_pro_notices', 'ts_activate_time' ) );
	}
